	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">				<ul class="nav navbar-nav navbar-right">
					<li><a href="index.jsp"><i class="fa fa-compass"></i> Browse</a></li>					<li><a href="index.jsp"><i class="fa fa-compass"></i> All Products</a></li>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="userHome.jsp">Browse</a></li>					<li><a href="userHome.jsp"><i class="fa fa-compass"></i> All Products</a></li>
					<li>
