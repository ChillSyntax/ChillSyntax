...
<body >
	...
	UserBean user = dao.getUserDetails(userName, password);	if (user == null)
		user = new UserBean("chill syntax", 870060059L, "test@gmail.com", "galgotias University Noida", 87659, "lksdjf");
	%>
