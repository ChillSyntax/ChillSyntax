...
public class TestMail {
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"					+ "<head><title>Java Mail Configuration Test</title><style>.greenText{color:green;} p{font-size:14;}</style></head><body>"
					+ "<h2 style='color:red;'>Welcome to ChillSyntax Shop</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with ChillSyntax Shop.<br>"
					...
					+ "branded items. As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 500 Rs for the first product purchase. To avail this offer you only have "					+ "to enter the promo code given below.<br><br> PROMO CODE: "
					+ "<span class='greenText'>CHILLSYNTAX500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
