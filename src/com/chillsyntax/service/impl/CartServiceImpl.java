package com.chillsyntax.service.impl;
...
import com.chillsyntax.beans.CartBean;
import com.chillsyntax.beans.DemandBean;
import com.chillsyntax.beans.ProductBean;
import com.chillsyntax.service.CartService;
import com.chillsyntax.utility.DBUtil;
	...
	public List<CartBean> getAllCartItems(String userId) {
		...
		try {
			...
			while (rs != null && rs.next()) {
				...
				cart.setQuantity(rs.getInt("quantity")); // Use getInt instead of parsing string
				items.add(cart);
			}
