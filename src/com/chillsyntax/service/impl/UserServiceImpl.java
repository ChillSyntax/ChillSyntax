...
import com.chillsyntax.constants.IUserConstants;
import com.chillsyntax.service.UserService;
import com.chillsyntax.utility.DBUtil;
import com.chillsyntax.utility.MailMessage;
...
public class UserServiceImpl implements UserService {
	...
	public String updateUser(UserBean user) {
		String status = "User Update Failed!";
		...
		try {
			ps = conn.prepareStatement("UPDATE " + IUserConstants.TABLE_USER + 
				" SET name=?, mobile=?, address=?, pincode=? WHERE email=?");
